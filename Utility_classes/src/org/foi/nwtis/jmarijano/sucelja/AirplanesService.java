...
public interface AirplanesService extends CRUDService<AvionLeti> {
    ...
    List<AvionLeti> dajSveAvionePoletjeleSAerdroma(String ident);

    int izbrisiSveAvionePolazisnogAerodroma(String ident);

    AvionLeti dajZadnjiPreuzetiAvionZaOdabraniAerodrom(String ident);
    
    int izbrisiAvionPolazisnogAerodroma(String ident, String icao24);
}
