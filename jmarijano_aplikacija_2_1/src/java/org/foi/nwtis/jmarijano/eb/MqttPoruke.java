...
public class MqttPoruke implements Serializable {
    ...
    public MqttPoruke(Integer id, String korisnik, String aerodrom, String avion, String poruka, String oznaka, Date vrijeme) {
        this.id = id;
    ...
    public String toString() {
        return "org.foi.nwtis.jmarijano.eb.MqttPoruke[ id=" + id + " ]";
    }
